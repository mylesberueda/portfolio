import type { SkillData } from '@/interfaces/skill';

export const SKILLS: SkillData[] = [
  { type: 'tech', name: 'JavaScript', experience: 'expert' },
  { type: 'tech', name: 'TypeScript', experience: 'expert' },
  { type: 'tech', name: 'React', experience: 'expert' },
